...
# core-site.xml
sudo -u hduser awk 'BEGIN{RS="</configuration>"}/<configuration>/{gsub(/<configuration>.*/,"<configuration><property><name>fs.default.name</name><value>hdfs://master:9000</value></property><property><name>hadoop.tmp.dir</name><value>/usr/local/hadoop/tmp</value></property></configuration>")}1' core-site.xml >> core-site.xml

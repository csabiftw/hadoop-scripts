...
sudo sh -c "ssh-copy-id -i /home/hduser/.ssh/id_dsa.pub hduser@slave1"
sudo sh -c "ssh-copy-id -i /home/hduser/.ssh/id_dsa.pub hduser@slave2"
sudo sh -c "ssh-copy-id -i /home/hduser/.ssh/id_dsa.pub hduser@slave3"
sudo sh -c "ssh-copy-id -i /home/hduser/.ssh/id_dsa.pub hduser@slave4"
sudo sh -c "ssh-copy-id -i /home/hduser/.ssh/id_dsa.pub hduser@slave5"
